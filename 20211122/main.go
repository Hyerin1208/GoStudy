/* 패키지 선언 */
// 이 코드가 어떤 패키지에 속하나?
// go 언어의 모든 코드는 반드시 패키지 선언을 시작
// package main : main 패키지에 속한 코드다 라는 걸 컴파일러에게 알려줌
...
func main() {
	...
	num2 := 10 // 선언대입문 : :=를 써서 var 키워드, 타입을 생략
	fmt.Println("var 키워드와 타입생략 방법", num2)
	...
	*/
	...
	/*
	00000000 00000000 0000001 01101000 => 360
	                          01101000 => 104
	*/
	...
	// 초기값을 넣지 않으면 아래와 같이 디폴트 값이 들어감
	// 그외 nil
	fmt.Println("초기값을 넣지 않으면 ?디폴트 값이 슉슉~ : ", defaultValueInteager)
